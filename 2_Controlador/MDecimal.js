...
function produceAvailableOperationDecimal(validOperations){
	var num=0;
	do{num=genRangeInteger(1,4)}while(validOperations[num]==0)
        return num;
}

function GenQuestionDecimal(startRange,finishRange,Operations,time,validOperations){
 	...
 	for (var i = 0; i < Operations; i++) {
                if(i!=0){
                        ope[i-1]=produceAvailableOperationDecimal(validOperations);
                        if(ope[i-1]==1){
 ...
 function LevelQuestionDecimales(level) {
 	var arr = new Array(4);

 	switch(level){
 		case 1:
 		arr = [0,0,0,1];
 		return GenQuestionDecimales(10,100,1,5,arr);
 		break;
 		case 2:
 		arr = [0,0,1,1];
 		return GenQuestionDecimales(10,100,1,5,arr);
 		...
 		case 3:
 		arr = [0,1,0,0];
 		return GenQuestionDecimales(0,100,1,7,arr);
 		break;
 		case 4:
 		arr = [1,0,0,0];
 		return GenQuestionDecimales(0,100,1,7,arr);
 		...
 		case 5:
 		arr = [0,1,1,1];
 		return GenQuestionDecimales(0,100,2,7,arr);
 		break;
 		case 6:
 		arr = [1,0,1,1];
 		return GenQuestionDecimales(0,100,2,7,arr);
 		...
 		case 8:
 		arr = [0,1,0,0];
 		return GenQuestionDecimales(100,1000,1,10,arr);
 		break;
 		case 9:
 		arr = [1,0,0,0];
 		return GenQuestionDecimales(10,10000,1,10,arr);
 		break;
 		default:
 		arr = [0,0,0,1];
 		return GenQuestionDecimales(10,100,1,5,arr);
